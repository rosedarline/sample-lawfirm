...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211120_rosesamplelawfirm_41b8ac5cb1610f1f5509_20211203194202_archive.zip';
	const ARCHIVE_SIZE		 = '34241155';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '41b8ac5-03194202';
    const SECONDARY_PACKAGE_HASH = '567ca43-03194202';
	const VERSION			 = '1.4.3';
