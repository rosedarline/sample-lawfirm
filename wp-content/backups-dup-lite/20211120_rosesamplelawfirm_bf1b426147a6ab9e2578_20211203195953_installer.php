...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211120_rosesamplelawfirm_bf1b426147a6ab9e2578_20211203195953_archive.zip';
	const ARCHIVE_SIZE		 = '34241365';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'bf1b426-03195953';
    const SECONDARY_PACKAGE_HASH = '5b27d32-03195953';
	const VERSION			 = '1.4.3';
