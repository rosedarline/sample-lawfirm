...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211120_rosesamplelawfirm_7b0d5f08b7c69baf5965_20211120210457_archive.zip';
	const ARCHIVE_SIZE		 = '34196151';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7b0d5f0-20210457';
    const SECONDARY_PACKAGE_HASH = 'a1ee311-20210457';
	const VERSION			 = '1.4.3';
